...
public interface IDbHelpers
{
    ...
    Task<List<SelectListItem>> PopulateDropDownAsync(string sqlQuery, string optionalLabel = "", string selectedValue = "", string disabledValue = "", string connectionStringName = "DefaultConnection");
}